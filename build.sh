...
if [[ $HOSTNAME =~ "fir" ]]; then
   ...
   g++ -std=c++11 -O2 -march=native -Wall -Wextra -Werror -I ./include -I ../libs/boost_1_61_0 -I ../libs/gmp-6.1.0 -Wl,-rpath -Wl,../libs/gmp-6.1.0/installdir/lib -L ../libs/gmp-6.1.0/installdir/lib -lgmp -lgmpxx wrapper.cpp ./lib/libdai.a -o wrapper
else
   make -j 8 && \
