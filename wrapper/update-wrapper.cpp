...
int main(int argc, char *argv[]) {
    if (argc != 4 && argc != 5) {
        cerr << "Usage: ./wrapper <factor-graph> <obs-file> <params-file> [<weights-file>]" << endl;
        return 1;
    }
    ...
    opts.set("maxiter", static_cast<size_t>(numeric_limits<size_t>::max()));
    opts.set("maxtime", Real(360000));
